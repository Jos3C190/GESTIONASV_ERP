...
PERMISSION_CATALOGUE: Sequence[PermissionSpec] = (
    ...
    PermissionSpec("documents:manage_folders", "Gestionar carpetas del espacio general", "documents"),
    PermissionSpec(
    ...
    PermissionSpec("products:variants", "Gestionar familias, atributos y variantes", "products"),
    PermissionSpec("products:master_data", "Gestionar la ficha maestra del producto", "products"),
    PermissionSpec("products:identifiers", "Gestionar identificadores del producto", "products"),
    PermissionSpec("products:suppliers", "Gestionar proveedores del producto", "products"),
    PermissionSpec("products:lifecycle", "Cambiar el ciclo de vida del producto", "products"),

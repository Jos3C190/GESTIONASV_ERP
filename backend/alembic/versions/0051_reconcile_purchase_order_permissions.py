"""Reconcile purchase-order RBAC catalogue rows and SUPER_ADMIN grants."""
...
PERMISSIONS = (
    ("purchase_orders:read", "Ver órdenes de compra", "purchase_orders"),
    (
        "purchase_orders:manage",
        "Crear, editar, enviar a aprobación y cancelar órdenes de compra",
        "purchase_orders",
    ),
    ("purchase_orders:approve", "Aprobar órdenes de compra", "purchase_orders"),
    ("purchase_orders:send", "Enviar órdenes de compra aprobadas", "purchase_orders"),
)
